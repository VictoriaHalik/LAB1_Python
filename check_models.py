from models import session, Client, Credit, Budget
...
credit1 = Credit(credit_id=1, sum_take=5000, sum_pay=6500, period_month=12,
...
budget = Budget(id=1, is_empty=False, available_sum=512000)
budget2 = Budget(id=2, is_empty=False, available_sum=457000)
